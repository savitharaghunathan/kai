...
class IncidentStore:
    ...
    def load_app_cached_violation(self, apps):
        ...
        for app in apps:
            ...
            output_yaml = IncidentStore.fetch_output_yaml(app)
            incident_store.add_application(app, output_yaml)
        print(f"Loaded incident store with {len(apps)} applications\n")
        return incident_store.cached_violations

    def fetch_output_yaml(app_name):
        """
